...
%>
<head>
    <title>“强素质、扬正气、促和谐”队伍专项教育活动</title>
...
<table cellspacing="0" cellpadding="0" align="center" border="0" width="1000">
    <tbody>
        <tr>
            <td valign="top" width="258" height="579" style="padding-right:5px;">
				<jsp:include page="left.jsp"></jsp:include>
            </td>
            <td valign="top" width="1" bgcolor="#0099FF" ></td>
            <td valign="top" height="579">
            ...
            <table height="521" cellspacing="0" cellpadding="0" width="730" align="center" border="0">
                <tbody>
                    <tr>
